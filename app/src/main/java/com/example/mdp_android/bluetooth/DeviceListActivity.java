...
public class DeviceListActivity extends Activity {
    ...
    private ArrayAdapter<String> mNewDevicesArrayAdapter; // for new devices
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize 2 array adapters - already paired devices, newly discovered devices
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                // If not already paired, add device to array
            ...
            // When discovery has started, change the Activity title
